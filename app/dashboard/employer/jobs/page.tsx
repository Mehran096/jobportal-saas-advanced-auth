              ...
              <div key={job._id} className="bg-white p-6 rounded-xl shadow-sm border hover:shadow-md transition">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-4 gap-2 mt-2">
                    ...
                    <Link href={`/dashboard/employer/jobs/${job._id}/edit`} className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-1 md:px-3 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-1.5 transition">
                      <Edit size={14} /> Edit
                    </Link>
                    <button onClick={() => handleDelete(job._id)} disabled={isDeleting} className="bg-red-50 hover:bg-red-100 text-red-600 px-3 py-2 rounded-lg text-sm font-medium flex items-center justify-center gap-1.5 transition disabled:opacity-50">
