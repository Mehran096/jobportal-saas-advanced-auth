              ...
              <div key={job._id} className="bg-white p-6 rounded-xl shadow-sm border hover:shadow-md transition">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-4 gap-2 mt-2">
                    ...
                    <Link href={`/dashboard/employer/applicants?jobId=${job._id}`} className="bg-blue-50 hover:bg-blue-100 text-blue-700 px-0.5 md:px-3 py-2 rounded-lg text-sm font-medium text-center transition">
                      Applicants
                    </Link>
