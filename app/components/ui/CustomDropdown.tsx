...
export default function CustomDropdown({ value, onChange, options, placeholder = "Select", variant = "default", widthClass = "w-20" }: Props) {
  ...
  const menu = open? (
    <div
      ...
      className="fixed bg-white border border-gray-20  rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.15)] z-9999 overflow-hidden animate-in fade-in slide-in-from-top-1"
    >
